...
describe('kargo adapter tests', function () {
  ...
  describe('build request', function() {
    ...
    it('works when all params and cookies are correctly set', function() {
      ...
      initializeKrgUid();
      initializeKrgCrb();
      testBuildRequests(getExpectedKrakenParams());
    });

    it('gracefully handles nothing being set', function() {
      testBuildRequests(getExpectedKrakenParams(true, true));
    });
    ...
    it('gracefully handles browsers without localStorage', function() {
      ...
      initializeKrgUid();
      initializeKrgCrb();
      testBuildRequests(getExpectedKrakenParams(false, true));
    });
    ...
    it('handles empty yet valid Kargo CRBs and UIDs', function() {
      ...
      testBuildRequests(getExpectedKrakenParams(true));
    });
    ...
    it('handles broken Kargo UIDs', function() {
      ...
      initializeKrgCrb();
      testBuildRequests(getExpectedKrakenParams({uid: true}));
    });
    ...
    it('handles broken Kargo CRBs where top level JSON is invalid', function() {
      ...
      testBuildRequests(getExpectedKrakenParams({crb: true}));
    });
  ...
  describe('response handler', function() {
    it('handles bid responses', function() {
      var bodyAppendSpy = sandbox.stub(document.body, 'appendChild');
